...
VBO as the vertex attribute's bound vertex buffer object so afterwards we can 
safely unbind 
...
unbind VAOs (nor VBOs) when it's not directly necessary. 
    ...
    { 
        ...
        float rotationValue = (float)angle++ * 0.1f; // Adjust rotation speed 
        model = glm::rotate(model, glm::radians(rotationValue), 
glm::vec3(glm::sqrt(0.5f), glm::sqrt(0.5f), 0.0f)); 
